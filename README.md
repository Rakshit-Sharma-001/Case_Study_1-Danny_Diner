...
All of the SQL work has been written in MySQL Workbench. Check out the above given site to find the relationship tables that have to be  created in Bonus Table 1 and 2.
